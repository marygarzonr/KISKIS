 ...
 */
public abstract class PasswordCallFactory {
...
//    private static final String NUMBER_CHARS = "0123456789";
    ...
    public static PasswordTemplate templateEntry;
    private static boolean useMixCase;
...
//    private static final String VOCAL_CHARS = "aeiouAEIOU";
    ...
    public static Password create(final int creationMode, final int length) {
        ...
        PasswordModeFactory passwordModeFactory = new PasswordModeFactory();
        Password pswMode = null;
        ...
        switch (creationMode) {
        case SECURE:
              pwd =  passwordModeFactory.createPasswordMode(SECURE, length, null, false); 
              break;
        case HUMAN_READABLE:
              pwd =  passwordModeFactory.createPasswordMode(HUMAN_READABLE, length, null,false);
              break;
        case TEMPLATE:
              pwd =  passwordModeFactory.createPasswordMode(TEMPLATE, length, templateEntry, useMixCase);      
               break;
        default:
...
//        assert pwd.getPwd().length == length;
    ...
    public static Password create(final PasswordTemplate template) {
        ...
        useMixCase = false;
        return create(TEMPLATE, 0);
    }
    
    public static Password create(PasswordTemplate template, boolean useMixCaseP) {
        templateEntry = template;
        useMixCase = useMixCaseP;
        return create(TEMPLATE, 0);
    }
