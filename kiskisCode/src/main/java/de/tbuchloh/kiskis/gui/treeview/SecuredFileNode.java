 ...
 * 
 * @author gandalf
 * @version $Id: SecuredFileNode.java,v 1.4 2007/02/18 14:37:51 tbuchloh Exp $
 */
public final class SecuredFileNode extends MyTreeNode {
	private static final ImageIcon IMAGE = Toolkit.loadImageIcon(
			"securedfile.png", SecuredFileNode.class); //$NON-NLS-1$

	/**
	 * creates a new SecuredFileNode
	 */
	protected SecuredFileNode() {
