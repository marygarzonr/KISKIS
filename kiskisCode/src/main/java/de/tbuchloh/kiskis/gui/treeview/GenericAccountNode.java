...
/**
 * <b>GenericAccountNode</b>:
 * 
 * @author gandalf
 * @version $Id: GenericAccountNode.java,v 1.4 2007/02/18 14:37:52 tbuchloh Exp
 *          $
 */
public final class GenericAccountNode extends MyTreeNode {
	private static final ImageIcon IMAGE = Toolkit.loadImageIcon(
			"generic_account_node.png", GenericAccountNode.class); //$NON-NLS-1$

	protected GenericAccountNode() {
	}
