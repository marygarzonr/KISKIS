 ...
 * @since 24.11.2010
 */
public final class SubmitBug extends AbstractSubmitFeedback {

    private static final Messages M = new Messages(SubmitBug.class);
    ...
    protected String createMailBody(String errorInformation) {
        if (errorInformation == null) {
            errorInformation = M.getString("emptyErrorInformation");
        }
        return M.format("body", //
                errorInformation, createSysteminformation(), createBuildInformation());
    }
