 ...
 * 
 * @author gandalf
 * @version $Id: BankAccountNode.java,v 1.4 2007/02/18 14:37:52 tbuchloh Exp $
 */
public final class BankAccountNode extends MyTreeNode {

	private static final ImageIcon IMAGE = Toolkit.loadImageIcon(
			"bank_account_node.png", BankAccountNode.class); //$NON-NLS-1$

	/**
	 * creates a new CreditCardNode
	 */
	protected BankAccountNode() {
	}
