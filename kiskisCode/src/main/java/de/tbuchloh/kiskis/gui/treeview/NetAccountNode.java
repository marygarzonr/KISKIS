 ...
 * 
 * @author gandalf
 * @version $Id: NetAccountNode.java,v 1.4 2007/02/18 14:37:52 tbuchloh Exp $
 */
public final class NetAccountNode extends MyTreeNode {
	private static final ImageIcon IMAGE = Toolkit.loadImageIcon(
			"netaccount.png", NetAccountNode.class); //$NON-NLS-1$

	protected NetAccountNode() {
	}
