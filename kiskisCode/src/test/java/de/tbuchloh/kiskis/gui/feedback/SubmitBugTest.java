...
public class SubmitBugTest {
     ...
     * Der Logger
     */
    private static final Log LOG = LogFactory.getLog(SubmitBugTest.class);

    private final AbstractSubmitFeedback object = new SubmitBug();
    ...
    public void testCreateMailToLinkWithInfo() throws Exception {
        ...
        LOG.info(s);
        Assert.assertThat(s, containsString("My%20error"));
    }
    ...
    public void testCreateMailSubject() throws Exception {
        ...
        LOG.info(s);
        Assert.assertThat(s, containsString("[BUG] Keep It Secret! Keep It Safe!"));
    }
    ...
    public void testCreateMailBody() throws Exception {
        ...
        LOG.info(s);
        Assert.assertThat(s, containsString("My information"));
    }
